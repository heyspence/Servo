...
ActiveRecord::Schema[7.0].define(version: 2024_02_17_205420) do
    ...
    add_foreign_key "pricing_input_options", "pricing_inputs", column: "pricing_input_id"
    ...
    add_foreign_key "user_inputs", "pricing_input_options", column: "input_option_id", optional: true
