...
const ProviderShow = () => {
  ...
  const { vendor, calendarData, userLoggedIn, serviceCharge } = useSelector(
    (state) => {
      return {
        vendor: state.vendors[id],
        calendarData:
          state?.vendors && state.vendors[id]?.calendarData
  ...
  let formattedDate = () => {
    if (vendorBooking?.appointmentAt) {
      return isMobile
        ...
        : format(
            parseISO(vendorBooking?.appointmentAt),
  ...
  return (
    <>
        ...
        <div className="provider-show">
          <div className="provider-show-left">
            ...
            <div className="disclaimer">
              At Servo, we ensure a seamless connection with skilled
              professionals. It's important to remember that Servo is a
              facilitator of these important interactions. For clarity on our
              role and responsibilities, we encourage you to review our Terms of
              Service. Your privacy matters to us; our Privacy Policy is
              designed with your security and trust in mind.
            </div>
          </div>
          ...
          <div className="provider-show-right">
            ...
            <ProviderScheduling
              ...
              calendarIntegration={
                vendor ? vendor.calendar.apiIntegrated : false
              }
      ...
      <OldModal isOpen={paymentGatewatOpen} onClose={togglePaymentGateway}>
